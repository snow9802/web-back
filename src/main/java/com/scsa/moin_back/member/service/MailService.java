...
public class MailService implements MailServiceInterface {
    ...
    public MimeMessage creatMessage(String to) throws MessagingException, UnsupportedEncodingException {
        ...
        message.setSubject("[Moin] 이메일 인증코드 입니다"); // 이메일 제목

        String msgg = "";
        // msgg += "<img src=../resources/static/image/emailheader.jpg />"; // header image
        msgg += "<h1>안녕하세요</h1>";
        msgg += "<h1>모두 모인 여기, Moin 입니다</h1>";
        msgg += "<br>";
        msgg += "<p>아래 인증코드를 인증번호란에 입력해주세요</p>";
        msgg += "<br>";
        msgg += "<br>";
        ...
        message.setFrom(new InternetAddress("moin@gmail.com", "Moin_Admin"));
